import pytest
import itertools
from schiavinato_sharing import split_mnemonic, recover_mnemonic, generate_valid_mnemonic
    ...
    *any* 3 shares out of 5 can recover the secret).
    ...
    def test_all_combinations(self, word_count, k, n):
        ...
        for subset in combinations:
            ...
            # Full validation
            assert result.success is True, f"Failed recovery for k={k}, n={n} with subset {[s.share_number for s in subset]}"
