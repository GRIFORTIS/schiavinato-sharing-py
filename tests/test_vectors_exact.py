...
class TestVectorsExactReproduction:
    ...
    def test_manual_polynomial_construction(self):
        ...
        word_polynomials = [[secret, coeff] for secret, coeff in zip(self.WORD_INDICES, self.COEFFICIENTS)]
        ...
        for x in [1, 2, 3]:
            ...
            assert generated_rows == expected['checksum_shares'], f"Checksum shares mismatch for share {x}"
