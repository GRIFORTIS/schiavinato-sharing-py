def create_qr_grid_v6(filename="qr_v6_grid_7x7.svg", cell_size_mm=5):
    """
    ...
    svg.append('<g stroke="#000" stroke-width="0.5" stroke-dasharray="1,2">')
    # Vertical lines
    ...
    # Pass 2: Strong solid lines for groups of 7 (except 2nd to last is 6)
    # Group boundaries at: 0, 7, 14, 21, 28, 34, 41
    group_indices = [0, 7, 14, 21, 28, 34, 41]

    svg.append('<g stroke="#000" stroke-width="1.5">')
    ...
    def rect(x, y, w, h, color="black"):
        return (
            ...
            f'width="{w * cell_px}" height="{h * cell_px}" fill="{color}"/>'
        )
